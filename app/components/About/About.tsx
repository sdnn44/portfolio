  ...
  return (
    <motion.div
      ...
      <div className='flex flex-col md:flex-row relative md:text-row max-w-6xl p-10 justify-between mx-auto items-center'>
        ...
        >
          <Image src={'/hero_bg-2.jpg'} width={340} height={340} alt={''} className='absolute top-13 right-4 -mb-20 md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-72 md:h-72 xl-w-[500px] xl-h-[600px] z-10' />
          <Image src={'/hero_bg-2.jpg'} width={340} height={340} alt={''} className='absolute bottom-12 -left-8 -mb-20 md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-72 md:h-72 xl-w-[500px] xl-h-[600px] z-10' />
