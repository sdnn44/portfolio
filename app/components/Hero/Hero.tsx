...
export default function Hero({ }: Props) {
  ...
  return (
    <div className='flex relative justify-center items-center gap-10 md:gap-20 md:flex-row flex-col max-w-5xl mx-auto h-3/4'>
      <div className='order-2 md:order-1 rounded-full flex items-center justify-center border-[1px] border-violet-800 shadow-[0_0px_20px_rgba(0,0,0,0.25)] shadow-violet-700 overflow-hidden'>
        <HeroBgAnimation />
        <Image src={'/hero_bg-2.jpg'} width={700} height={700} alt={''} className='z-10 w-52 h-52 md:w-full md:h-full' />
